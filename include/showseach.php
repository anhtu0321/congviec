...
$sql="select id,noidung,han,giaocho,luu,file,trangthai,ngaynhap,nguoinhap,ngayxong from congviec where nguoinhap = '$nguoinhap' and (noidung LIKE '%$noidung%')";
if($hantk != ""){$sql = $sql." and han = '$hantk'";}
if($trangthai != ""){$sql = $sql." and trangthai LIKE '%$trangthai%'";}
$tb = mysql_query($sql); 
